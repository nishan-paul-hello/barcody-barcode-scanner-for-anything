...
export const Footer: React.FC = () => {
  return (
    <footer className="relative mx-auto flex h-16 w-[95%] max-w-7xl items-center rounded-2xl border border-white/10 bg-black/40 shadow-2xl shadow-black/50 backdrop-blur-xl">
