...
export default function NotFound() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center overflow-hidden bg-[#0d0d0d] text-zinc-100 selection:bg-white/10 selection:text-white">
